...
public class modificationRappel extends AppCompatActivity {
    Rappel r = new Rappel();
    String rap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modification_rappel);
        ...
        editor.putBoolean("modifie", true);
        editor.commit();
        ...
        if (r.typeAncien != -1)
            textView.setText(r.decrisQuandRappeAncien("L'ancien rappel de type ")+"\n");
        if  (r.type != -1){
            textView.setText(r.decrisQuandRappeAncien("L'ancien rappel de type ")+r.decrisQuandRappel("\nLe nouveau rappel de type "));
        ...
        private View.OnClickListener listenerbouton = new View.OnClickListener() {
            ...
            monDialogue.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    if (r.isARappel()) {
                            Communication.envoieCommande(Communication.createCommande("modifieRappel", r.toString()),false);
                            Toast toast = Toast.makeText(modificationRappel.this, "Rappel ajouté !", Toast.LENGTH_LONG);
                            toast.show();
                            retournerMenuReveil();
            ...
            monDialogue.setNeutralButton("Annuler", new DialogInterface.OnClickListener() {
                ...
                monDialogue.setNegativeButton("Non", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast toast = Toast.makeText(modificationRappel.this, "Ajout de rappel annulé !", Toast.LENGTH_LONG);
                        toast.show();
                        retournerMenuReveil();
    ...
    public void retournerMenuReveil(){
        Intent intent = new Intent (modificationRappel.this , MenuReveil.class);
    ...
    private View.OnClickListener listenerbouton2 = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent (modificationRappel.this , quandMenu.class);
    ...
    private View.OnClickListener listenerbouton3 = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent (modificationRappel.this , affichageCommande.class);
            intent.putExtra("rappel",r.toString());
            intent.putExtra("modifie","a");
            startActivity(intent) ;
    ...
    private View.OnClickListener listenerbouton4 = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent (modificationRappel.this , ajoutCommande.class);
            intent.putExtra("rappel",r.toString());
            intent.putExtra("modifie","a");
            startActivity(intent) ;
    ...
    private View.OnClickListener listenerbouton5 = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent (modificationRappel.this , modifierCommande.class);
            intent.putExtra("rappel",r.toString());
            intent.putExtra("modifie","a");
            startActivity(intent) ;
    ...
    private View.OnClickListener listenerbouton6 = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent (modificationRappel.this , suppressionCommande.class);
            intent.putExtra("rappel",r.toString());
            intent.putExtra("modifie","a");
            startActivity(intent) ;
